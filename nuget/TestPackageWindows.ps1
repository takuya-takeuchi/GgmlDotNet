...
$BuildTargets = @()
$BuildTargets += New-Object PSObject -Property @{Package = "GgmlDotNet";     PlatformTarget="x64"; RID = "$OperatingSystem-x64"; }
#$BuildTargets += New-Object PSObject -Property @{Package = "GgmlDotNet";     PlatformTarget="x86"; RID = "$OperatingSystem-x86"; }
