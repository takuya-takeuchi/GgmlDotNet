...
foreach($BuildTarget in $BuildTargets)
{
   ...
   {
      Write-Host "Start 'docker run --rm -v ""$($GgmlDotNet):/opt/data/GgmlDotNet"" -e LOCAL_UID=$(id -u $env:USER) -e LOCAL_GID=$(id -g $env:USER) -t $dockername'" -ForegroundColor Green
