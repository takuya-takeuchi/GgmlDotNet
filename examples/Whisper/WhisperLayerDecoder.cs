...
namespace Whisper
{
    ...
    internal sealed class whisper_layer_decoder
    {
        ...
        public GgmlTensor cross_attn_ln_0_w { get; set; }

        public GgmlTensor cross_attn_ln_0_b { get; set; }

        public GgmlTensor cross_attn_ln_1_w { get; set; }

        public GgmlTensor cross_attn_ln_1_b { get; set; }

        public GgmlTensor cross_attn_q_w { get; set; }

        public GgmlTensor cross_attn_q_b { get; set; }

        public GgmlTensor cross_attn_k_w { get; set; }

        public GgmlTensor cross_attn_v_w { get; set; }

        public GgmlTensor cross_attn_v_b { get; set; }
